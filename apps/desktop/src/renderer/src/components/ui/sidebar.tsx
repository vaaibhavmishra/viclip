...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: Cookie is required for SSR
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-sidebar/80 text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col backdrop-blur-xl",
          className,
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar/80 text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden backdrop-blur-xl backdrop-saturate-150"
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar/50 group-data-[variant=floating]:ring-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-glass group-data-[variant=floating]:ring-1 flex size-full flex-col backdrop-blur-md"
        >
          {children}
        </div>
      </div>
